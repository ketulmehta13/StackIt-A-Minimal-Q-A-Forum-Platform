...
SECRET_KEY = 'django-insecure-@(an-qj!l#ewo3=qbmrrfqml3yv%z+d4sp&ln!4(kij4imo&t-'
...
# CORS Configuration (for development with React)
CORS_ALLOW_ALL_ORIGINS = True # Be more restrictive in production!
# Example for specific origins (replace with your React app's URL):
